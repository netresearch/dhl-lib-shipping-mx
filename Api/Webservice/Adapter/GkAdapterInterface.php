...
interface GkAdapterInterface extends AdapterInterface
{
     ...
     * @param \Dhl\Versenden\Api\Webservice\Response\Parser\GetVersionParserInterface $parser
     *
     * @return \Dhl\Versenden\Api\Webservice\Response\Type\GetVersionResponseInterface
     */
    public function getVersion(GetVersionRequestInterface $request, GetVersionParserInterface $parser);

    /**
     * @param \Dhl\Versenden\Api\Webservice\Request\Type\DeleteShipmentRequestInterface $request
     * @param \Dhl\Versenden\Api\Webservice\Response\Parser\DeleteShipmentParserInterface $parser
     *
     * @return \Dhl\Versenden\Api\Webservice\Response\Type\DeleteShipmentResponseInterface
     */
    public function deleteShipmentOrder(DeleteShipmentRequestInterface $request, DeleteShipmentParserInterface $parser);
}
