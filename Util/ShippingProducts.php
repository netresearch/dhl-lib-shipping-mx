...
class ShippingProducts implements BcsShippingProductsInterface, GlShippingProductsInterface
{
    ...
    public function getProductName($code)
    {
        $names = [
            ...
            self::CODE_AMER_PKY => 'DHL Packet International (PKY)',
            self::CODE_AMER_PKD => 'DHL Packet International (PKD)',
            self::CODE_AMER_29  => 'DHL Packet International (29)',
            self::CODE_AMER_PLY => 'DHL Parcel International Standard (PLY)',
            self::CODE_AMER_PKT => 'DHL Parcel International Standard (PKT)',
            self::CODE_AMER_54  => 'DHL Parcel International Standard (54)',
            self::CODE_AMER_PID => 'DHL Parcel International Direct Standard (PID)',
            self::CODE_AMER_22  => 'DHL Parcel International Direct Standard (22)',
            self::CODE_AMER_PLT => 'DHL Parcel International Direct (PLT)',
            self::CODE_AMER_60  => 'DHL Parcel International Direct (60)',
            self::CODE_AMER_PLX => 'DHL Parcel International Expedited (PLX)',
